...
export default function ReverseMeaningGame({ words, language, onClose }: ReverseMeaningGameProps) {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-2xl font-bold">Reverse Meaning</h2>
          <p className="text-sm text-muted-foreground">Translate from {language.name} to English</p>
        </div>
      </div>
      ...
      <Card>
        <CardContent className="pt-6 space-y-6">
          ...
          <div className="text-center py-8">
            ...
            <p className="text-4xl font-bold">{currentWord.foreign}</p>
          </div>
